...
1. 版本检测
2. 账号密码
3. 下载路径（程序会将课件下载到该文件夹）
4. 课程号（在需要学习的MOOC课程网址中找到'XXX-ddddddd'格式中后面的数字部分 将其复制过来即可，其中XXX指大写字母，为学校名英文缩写，其后为一串数字，就是课程号）
5. 学期号（选择下载第几次开课内容）
...
## 关于
Sigure_Mo Python新手，于中国大学MOOC下嵩天老师的`Python语言程序设计`自学Python，从Python开始逐渐接触各方面计算机知识，从此一发不可收，正在逐渐向计算机专业方向转型